...
export const blogItems = [
  {
    ...
    img: blog1,
    date: "23 April 2023",
    title: "From Comfort to Style: Exploring the World of Luxurious Sofas",
    description:
      "Discover the world of sofa styles that cater to every home's unique character. In this insightful guide, we delve into a plethora of sofa designs, ranging from modern and minimalistic to timeless and traditional. Explore how different styles can harmonize with various interior aesthetics and elevate your living spaces. Whether you're seeking a statement piece or a cozy haven for relaxation, this article provides valuable insights into selecting the perfect sofa that not only complements your decor but also embraces your comfort preferences. Embark on a journey of design exploration and find your ideal sofa style that speaks to the heart of your home.",
    numComments: 23,
  },
  {
    id: 2,
    img: blog2,
    date: "11 May 2023",
    title: "Organizational Bliss: Taming Clutter with Stylish Bookcase",
    description:
      "Transform your bookcase into a stunning showcase of your literary treasures in our guide to Bookcase Beauties. We unravel the art of curating an awe-inspiring arrangement that not only highlights your beloved books but also complements your interior decor. Dive into innovative ways to arrange and style your bookcase, incorporating elements such as artwork, decorative objects, and personal mementos. Discover how to strike the perfect balance between organization and aesthetics, creating a mesmerizing focal point that reflects your personality and passions. Elevate your reading nook and living space with this guide's tips on infusing panache and charm into your bookcase display.",
    numComments: 203,
  },
  {
    id: 3,
    img: blog3,
    date: "5 June 2023",
    title: "Essential Furniture for a Functional Kids' Space",
    description:
      "Embark on a journey of imagination and creativity as we delve into the world of designing dreamy kids' bedrooms. Our guide offers a treasure trove of tips and ideas to craft a whimsical and functional space that nurtures your child's growth and happiness. From playful color palettes to innovative storage solutions, explore how to strike the perfect balance between functionality and enchantment. Discover age-appropriate decor ideas that can evolve with your child, ensuring a space that accommodates their changing needs and interests. Join us as we unlock the secrets to creating a child's room that fosters creativity, comfort, and joy.",
    numComments: 70,
  },
  {
    id: 4,
    img: blog4,
    date: "29 July 2023",
    title: "The Art of Seating: Exploring Iconic Chair Designs for Your Home",
    description:
      "Step into the realm of seating elegance with our exploration of iconic chair designs that transcend mere functionality. The Art of Seating guide takes you on a journey through time, unveiling chairs that have become symbols of design ingenuity and craftsmanship. Discover how chairs can be more than just seating; they can be works of art that redefine the aesthetics of your living spaces. From classic mid-century modern to avant-garde contemporary designs, we showcase chairs that make a statement while offering comfort and style. Immerse yourself in the world of chair design and elevate your interiors with pieces that tell a story of innovation and beauty.",
    numComments: 127,
  },
  {
    id: 5,
    img: blog5,
    date: "11 August 2023",
    title: "Living Room Bliss: Design Ideas for Creating a Relaxing Oasis",
    description:
      "Welcome to Living Room Bliss, where we unveil a collection of design ideas that transform your living room into a serene haven of relaxation and comfort. In this guide, we explore various elements that contribute to a harmonious living space, from furniture arrangement and color palettes to lighting and decor accents. Learn how to curate an inviting atmosphere that encourages relaxation and fosters connections. Whether you're a fan of minimalist aesthetics or crave cozy elegance, our insights will guide you in creating a living room oasis where both style and comfort coexist in perfect harmony.",
    numComments: 31,
  },
];
